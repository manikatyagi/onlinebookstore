        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <ul class="menu-list">
                    ...
                    <li><a href="latest_products.php">Recently added books</a></li>
                    <li><a href="popular_products.php">Most viewed books</a></li>
                </ul>
            </div>
            <div class="col-md-3">
                <h3>Contact Us</h3>
            ...
            <div class="col-md-12">
                <span><?php echo $footer[0]['footer_text'] ?> | Created by <a href="" target="_blank">Manika Tyagi, Arjun PS, Aakriti Jain</a></span>
            </div>
        </div>
    </div>
</div>
